...
<div class="container-fluid">
    ...
    <div class="mb-3 d-flex justify-content-between align-items-center">
        <a href="{{ route('kategori.create') }}" class="btn btn-primary" style="max-width: 180px; width:100%;"><i class="fas fa-plus-circle"></i> Tambah Kategori</a>
            ...
            <tr>
                ...
                <td class="text-center">
                    @if ($kategori->foto_kategori)
                        <img src="{{ Storage::url($kategori->foto_kategori) }}" alt="foto_kategori" width="100">
                    @else
