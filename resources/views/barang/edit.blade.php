        ...
        <div class="card-body">
            ...
            <form action="{{ route('barang.update', $barang->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="text" name="nama_barang" class="form-control rounded-3 @error('nama_barang') is-invalid @enderror" value="{{ old('nama_barang', $barang->nama_barang) }}">
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="text" name="ukuran" class="form-control rounded-3 @error('ukuran') is-invalid @enderror" value="{{ old('ukuran', $barang->ukuran) }}">
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="number" name="harga" class="form-control rounded-3 @error('harga') is-invalid @enderror" value="{{ old('harga', $barang->harga) }}">
                        @error('harga') <span class="text-danger">{{ $message }}</span> @enderror
                    </div>
                    <div class="col-md-6">
                        <label class="fw-semibold">Stok</label>
                        <input type="number" name="stok" class="form-control rounded-3 @error('stok') is-invalid @enderror" value="{{ old('stok', $barang->stok) }}">
