...
<div class="container mt-4">
    <div class="card shadow-sm rounded-4">
        <div class="card-body">
            <h4 class="mb-4 fw-bold">Tambah Barang Baru</h4>
            <form action="{{ route('barang.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="text" name="nama_barang" class="form-control rounded-3 @error('nama_barang') is-invalid @enderror" value="{{ old('nama_barang') }}">
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="text" name="ukuran" class="form-control rounded-3 @error('ukuran') is-invalid @enderror" value="{{ old('ukuran') }}">
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="number" name="harga" class="form-control rounded-3 @error('harga') is-invalid @enderror" value="{{ old('harga') }}">
                        @error('harga') <span class="text-danger">{{ $message }}</span> @enderror
                    </div>
                    <div class="col-md-6">
                        <label class="fw-semibold">Stok</label>
                        <input type="number" name="stok" class="form-control rounded-3 @error('stok') is-invalid @enderror" value="{{ old('stok') }}">
                ...
                <div class="form-group mb-3">
                    ...
                    <textarea name="deskripsi" class="form-control rounded-3 @error('deskripsi') is-invalid @enderror">{{ old('deskripsi') }}</textarea>
