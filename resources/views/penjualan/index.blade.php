...
<div class="container-fluid">
    ...
    <div class="mb-3 d-flex justify-content-between align-items-center">
        <a href="{{ route('penjualan.create') }}" class="btn btn-primary" style="max-width: 150px; width:100%;"><i class="fas fa-plus-circle"></i> Tambah Data</a>
                ...
                <tr>
                    ...
                    <td class="text-center">
                        @if ($penjualan->bukti_transaksi)
                            <img src="{{ Storage::url($penjualan->bukti_transaksi) }}" alt="bukti_transaksi" width="100">
